...
* define paths
	loc		rootw 	= 	"$data/weather_data/tanzania/wave_2/refined"
	loc		rooth 	= 	"$data/household_data/tanzania/wave_2/refined"
...
* define local with all sub-folders in it
	loc 		folderList : dir "`rootw'" dirs "npsy2_rf*"
...
* loop through each file in the above local
	...
	* merge weather data with household data
		merge 	1:1 y2_hhid using "`rootw'/`folder'/`file'"	
		...
		*drop variables for all years but 2010
			drop 		mean_season_1983- dry_2009 mean_season_2011- dry_2016
			drop 		mean_period_total_season- z_total_season_2009 ///
						dev_total_season_2011- z_total_season_2016
			drop 		mean_period_raindays- dev_raindays_2009 ///
						dev_raindays_2011- dev_raindays_2016
			drop 		mean_period_norain- dev_norain_2009 ///
						dev_norain_2011- dev_norain_2016
			drop 		mean_period_percent_raindays- dev_percent_raindays_2009 ///
						dev_percent_raindays_2011- dev_percent_raindays_2016	
...
* define local with all sub-folders in it
	loc 		folderList : dir "`rootw'" dirs "npsy2_t*"
	...
	* merge weather data with household data
		...
		* drop variables for all years but 2010
			drop 		mean_season_1983- tempbin1002009 ///
						mean_season_2011- tempbin1002016
			drop 		mean_gdd- z_gdd_2009 dev_gdd_2011- z_gdd_2016
